...
const MeditationHall = () => {
  ...
  if (!data || data.length === 0) {
    return <NoDataContainer><b>No Meditation Hall Data Available</b></NoDataContainer>;
  }

  const filteredData = data.filter(item => item.id === 8);

  if (filteredData.length === 0) {
    return <NoDataContainer><b>No Prayer Rooms Data Available </b></NoDataContainer>;
  }
