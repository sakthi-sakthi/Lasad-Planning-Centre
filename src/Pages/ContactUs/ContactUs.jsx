...
const ContactUs = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!validateName(formData.name) || !validateEmail(formData.email) || !validateMobile(formData.mobile) || !formData.message) {
            return;
        }

        setLoading(true);

        axios.post(`${ApiUrl}/store/contact`, formData)
            .then((response) => {
                Swal.fire({
                    icon: 'success',
                    title: 'Success!',
            ...
            <div className="contact-2 content-area-6">
                <div className="container">
                    <div className="main-title mb-60">
                        <h1>Contact Us</h1>
                        <p>
                            "Connecting Dreams, Crafting Solutions - Your Journey Begins with Us!"
                        </p>
                    </div>
                    <div className="row">
                        <div className="col-lg-4 col-md-12 col-sm-12">
                            <div className="contact-info">
                                ...
                                <ul className="contact-list">
                                    <li>
                                        <i className="fa fa-map-marker" /> The Manager Benilde-Boys Town, Pulluthu, Nagamalai, Madurai - 625019
                                    </li>
                                    <li>
                                        <a href="tel:9943339446,6385827007">
                                            <i className="fa fa-phone" /> 9943339446 / 6385827007
                                        </a>
                                    </li>
                                    <li>
                                        <a href="mailto:info@benilde.com">
                                            <i className="fa fa-envelope" /> info@benilde.com
                                        </a>
                                    </li>
                                </ul>
                                <h3>Follow Us</h3>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12 col-md-12">
                                            <div className="send-btn text-center">
                                                <button type="submit" className="btn-md btn-theme btn-4 btn-7" disabled={loading}>
